...
// No active state
#define BH1750_POWER_DOWN 0x00  //循迹状态 

// Wating for measurment command
#define BH1750_POWER_ON 0x01 //k竞赛平台停止 

// Reset data register value - not accepted in POWER_DOWN mode
#define BH1750_RESET 0x07	//码盘清零 

// Start measurement at 1lx resolution. Measurement time is approx 120ms.
#define BH1750_CONTINUOUS_HIGH_RES_MODE  0x10 //前三字节红外数据 

// Start measurement at 0.5lx resolution. Measurement time is approx 120ms.
#define BH1750_CONTINUOUS_HIGH_RES_MODE_2  0x11	//后三字节红外数据 
...
class _BH1750 {
  ...
  public:
	  _BH1750(byte addr = 0x23);
    void Initialization(uint8_t mode = BH1750_CONTINUOUS_HIGH_RES_MODE);
